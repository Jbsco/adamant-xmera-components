--------------------------------------------------------------------------------
-- Rate_Control Component Tester Spec
--------------------------------------------------------------------------------

-- Includes:
with Component.Rate_Control_Reciprocal;
...
-- guidance.
package Component.Rate_Control.Implementation.Tester is

   use Component.Rate_Control_Reciprocal;
   ...
   package Torque_Command_History_Package is new Printable_History (Packed_F32x3_Record.T, Packed_F32x3_Record.Representation.Image);

   -- Component class instance:
   type Instance is new Component.Rate_Control_Reciprocal.Base_Instance with record
      -- The component instance under test:
      Component_Instance : aliased Component.Rate_Control.Implementation.Instance;
      -- Connector histories:
      Data_Product_Fetch_T_Service_History : Data_Product_Fetch_T_Service_History_Package.Instance;
      Data_Product_T_Recv_Sync_History : Data_Product_T_Recv_Sync_History_Package.Instance;
      -- Data product histories:
      Torque_Command_History : Torque_Command_History_Package.Instance;
   ...
   overriding procedure Torque_Command (Self : in out Instance; Arg : in Packed_F32x3_Record.T);
